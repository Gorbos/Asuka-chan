...
public class ImageGroup extends ViewGroup {
    ...
    public ImageGroup(Context context, AttributeSet attrs, int defStyle) {
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new ImageGroup.LayoutParams(getContext(), attrs);
    }
...
//            TypedArray a = c.obtainStyledAttributes(attrs, R.styleable.ImageGroupLP);
//            gravity = a.getInt(R.styleable.ImageGroupLP_android_layout_gravity, gravity);
//            position = a.getInt(R.styleable.ImageGroupLP_layout_position, position);
//            a.recycle();
        }
